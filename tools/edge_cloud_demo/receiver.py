...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--ack-bind", default=None, help="Optional ACK PUB endpoint, e.g. tcp://*:5556")
        ...
        while True:
            ...
            if ack_pub is not None:
                ack_header = {
                    ...
                    "sender_ts_unix": header.get("ts_unix", ""),
                    "receiver_recv_ts_unix": now,
                }
                ack_pub.send_multipart(
                    [ack_topic_bytes, msgpack.packb(ack_header, use_bin_type=True)], copy=False
                )
